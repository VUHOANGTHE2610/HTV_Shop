...
string connectionString = @"server=INAMORATO;user id=sa;password=123;database=LiteCommerceDB;TrustServerCertificate=true";
SV21T1020178.BusinessLayers.Configuration.Initialize(connectionString);
